...
function save_master_data(action){
	...
	$('saveDataForm').action = get_kumbia_url(document.fl.aaction.value + "/" + action)
...
function save_helper(helper){
	...
	var url        = get_kumbia_url(document.fl.aaction.value+"/_save_helper")+"?name="+helper+"&valor="+$(helper+"_helper").value
	var urlrequest = get_kumbia_url(document.fl.aaction.value+"/_get_detail/")+"?name="+helper+"&valor="+$(helper+"_helper").value
