...
abstract class StandardForm extends Controller  {
	...
	/**
	 * Lista de campos a ignorar en la generación
	 *
	 * @var array
	 */
...
//	public public function report(){
	...
	//	$this->view = 'index';
		 ...
		 * before_report, si este m&eacute;todo devuelve false termina la ejecuciï¿½n
		 * de la acci&oacute;n
		 */   /*
		...
		/**
		 * Busca si existe un m&eacute;todo o un llamado variable al m&eacute;todo
		 * after_insert, si este m&eacute;todo devuelve false termina la ejecuciï¿½n
		 * de la acci&oacute;n
		 */
...
//	}
	...
	public function delete(){
		...
		/**
		 * Busca si existe un m&eacute;todo o un llamado variable al m&eacute;todo
		 * before_delete, si este m&eacute;todo devuelve false termina la ejecuciï¿½n
		 * de la acci&oacute;n
		 */
	...
	public function fetch($id){
		...
		/**
		 * Busca si existe un m&eacute;todo o un llamado variable al m&eacute;todo
		 * before_fetch, si este m&eacute;todo devuelve false termina la ejecuciï¿½n
		 * de la acci&oacute;n
		 */
	...
	* el formulario
	* La funciï¿½n buildForm es la encargada de crear el formulario
	...
	*/
	...
	/**
	 * Indica que un campo tendrï¿½ un helper de ayuda
	 *
	 * @param string $field
	 * @param string $helper
	 */
	...
	/**
	 * Indica que un campo serï¿½ de tipo imagen
	 *
	 * @param string $what
	 */
	...
	/**
	 * Indica que un campo serï¿½ de tipo numerico
	 *
	 * @param string $what
	 */
	...
	/**
	 * Indica que un campo serï¿½ de tipo Time
	 *
	 * @param string $what
	 */
	...
	/**
	 * Indica que un campo serï¿½ de tipo fecha
	 *
	 * @param string $what
	 */
	...
	/**
	 * Indica que un campo serï¿½ de tipo password
	 *
	 * @param string $what
	 */
	...
	/**
	 * Indica que un campo serï¿½ de tipo textarea
	 *
	 * @param string $what
	 */
	...
	/**
	 * Indica una lista de campos recibirï¿½n entrada solo en mayï¿½sculas
	 *
	 */
	...
	/**
	 * Permite cambiar el tamaï¿½o (size) de un campo $what a $size
	 *
	 * @param string $what
	 * @param integer $size
	 */
	...
	/**
	 * Permite cambiar el tamaï¿½o mï¿½ximo de caracteres que se puedan
	...
	/**
	 * Indica que un campo serï¿½ de tipo Hidden
	 *
	 */
