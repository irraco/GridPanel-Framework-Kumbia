...
class DbMySQLi extends DbBase implements DbBaseInterface  {
	...
	/**
	 * DSN de conexi&oacute;n a MySQL
	 *
	 * @var string
	 */
	private $db_dsn;
	...
	public function connect($dbhost='', $dbuser='', $dbpass='', $dbname='', $dbport='', $dbdsn=''){
		...
		if(!extension_loaded('mysqli')){
			throw new DbException('Debe cargar la extensión de PHP llamada php_mysqli');
			return false;
		}
		...
		if($this->id_connection = @mysqli_connect($this->db_host, $this->db_user, $this->db_pass, $this->db_name, $this->db_port)){
			return true;
		} else {
